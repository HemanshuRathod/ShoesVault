...
// app.use(cors({
//   origin: "https://shoes-vault-451a.vercel.app", // Tamari Vercel URL
...
// CORS Configuration (Live Deployment mate mukhya)
app.use(cors({
  origin: ["https://shoes-vault-451a.vercel.app", "http://localhost:5000"], // Vercel link ane Local testing banne allow thase
  methods: ["GET", "POST", "PUT", "DELETE"],
  credentials: true
}));

// --- MongoDB Connection ---
// Tame Shard connection vapryu chhe te sachu chhe
const MONGO_URI = "mongodb://users_2004:admin%4012@ac-etgd3qy-shard-00-00.yvgp6x2.mongodb.net:27017,ac-etgd3qy-shard-00-01.yvgp6x2.mongodb.net:27017,ac-etgd3qy-shard-00-02.yvgp6x2.mongodb.net:27017/shoevault1?ssl=true&replicaSet=atlas-ls613l-shard-0&authSource=admin&appName=NODE";
